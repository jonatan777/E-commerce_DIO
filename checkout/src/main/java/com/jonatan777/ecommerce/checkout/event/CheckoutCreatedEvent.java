 ...
 */
package com.jonatan777.ecommerce.checkout.event;
...
public class CheckoutCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9119953217348233344L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CheckoutCreatedEvent\",\"namespace\":\"com.jonatan777.ecommerce.checkout.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[\"string\",\"null\"]},{\"name\":\"status\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder() {
    return new com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder(com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder other) {
    if (other == null) {
      return new com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder(com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent other) {
    if (other == null) {
      return new com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CheckoutCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder setCheckoutCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jonatan777.ecommerce.checkout.event.CheckoutCreatedEvent.Builder clearStatus() {
      status = null;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 0) {
        ...
        this.checkoutCode = in.readString(this.checkoutCode instanceof Utf8 ? (Utf8)this.checkoutCode : null);
      }
